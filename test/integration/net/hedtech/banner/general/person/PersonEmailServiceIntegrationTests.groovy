...
class PersonEmailServiceIntegrationTests extends BaseIntegrationTestCase {
    ...
    void testEmailAddressByVendorPidm( ) {
        def result = personEmailService.findVendorEmailAddress( 30450 )
    ...
    void testEmailAddressByVendorPidmAndActiveEmails( ) {
        def result = personEmailService.findVendorEmailAddressList( 30450 , [searchParam:''],  [max: 10, offset: 0] )
        assertNotNull result
    ...
    void testFetchByEmailAddressByVendorPidmAndSearchOption( ) {
        def result = personEmailService.findVendorEmailAddressList( 30450 , [searchParam:'dhareppa'],  [max: 10, offset: 0] )
        assertTrue  result.size() > 0
    }

    @Test
    void testFetchByEmailAddressByVendorPidmAndInvalidSearchOption( ) {
        def result = personEmailService.findVendorEmailAddressList( 30450 , [searchParam:'INVALID'],  [max: 10, offset: 0] )
        assertTrue result.size() == 0
    }
}
