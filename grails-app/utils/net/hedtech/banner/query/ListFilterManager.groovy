...
class ListFilterManager {
     ...
     * It is an array of maps. Each map has the following elements:
     *      field: The field for the filter
     *      value: The value for this field. For validation fields, if the operator (below) is eq or ne,
     *          the value will be the code matching the entry in the validation table.
