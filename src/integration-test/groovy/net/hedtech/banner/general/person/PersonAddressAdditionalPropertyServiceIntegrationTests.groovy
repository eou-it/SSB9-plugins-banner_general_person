...
@Integration
@Rollback
class PersonAddressAdditionalPropertyServiceIntegrationTests extends BaseIntegrationTestCase {
    ...
    void testFetchAllBySurrogateIds() {
        ...
        def personAddExtendedProperties = personAddressAdditionalPropertyService.fetchAllBySurrogateIds([personAddress.id])[0]
    ...
    void testCreateNotAllowed() {
        shouldFail(ApplicationException) {
            personAddressAdditionalPropertyService.create([personAddressExtendedProperties: new PersonAddressAdditionalProperty()])
        }
    }
    ...
    void testDeleteNotAllowed() {
        shouldFail(ApplicationException) {
            personAddressAdditionalPropertyService.delete([personAddressExtendedProperties: new PersonAddressAdditionalProperty()])
        }
    }
