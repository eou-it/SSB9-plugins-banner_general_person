...
REM AUDIT TRAIL END
REM
CREATE OR REPLACE FORCE VIEW SV_SPRIDEN_ALT AS SELECT
      spriden_pidm,
      spriden_id,
      spriden_last_name,
      spriden_first_name,
  ...
  FROM spriden
  WHERE spriden_change_ind IS NOT NULL;
REM
CREATE OR REPLACE PUBLIC SYNONYM SV_SPRIDEN_ALT FOR SV_SPRIDEN_ALT;