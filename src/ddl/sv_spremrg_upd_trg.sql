...
-- AUDIT TRAIL END
--
CREATE OR REPLACE TRIGGER spremrg_view_update_trg
  INSTEAD OF UPDATE ON sv_spremrg
BEGIN
  gfksjpa.setId(:OLD.spremrg_surrogate_id);
