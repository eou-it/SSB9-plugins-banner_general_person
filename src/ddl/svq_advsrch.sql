...
(contains(SPRIDEN.SPRIDEN_SEARCH_LAST_NAME, NAME1)>0
     Or contains(SPRIDEN.SPRIDEN_SEARCH_FIRST_NAME, NAME1)>0
     Or contains(SPRIDEN.SPRIDEN_SEARCH_MI, SVQ_NAME_PARAMS.NAME1)>0)
And ( NAME2  = '%' or
  (contains(SPRIDEN.SPRIDEN_SEARCH_LAST_NAME,NAME2)>0
    Or Contains(SPRIDEN.SPRIDEN_SEARCH_FIRST_NAME,NAME2)>0
    Or Contains(SPRIDEN.SPRIDEN_SEARCH_MI,SVQ_NAME_PARAMS.NAME2)>0) )
And ( name3  = '%' or
   (Contains(SPRIDEN.SPRIDEN_SEARCH_LAST_NAME,NAME3)>0
    Or Contains(SPRIDEN.SPRIDEN_SEARCH_FIRST_NAME,NAME3)>0
    Or Contains(SPRIDEN.SPRIDEN_SEARCH_MI,SVQ_NAME_PARAMS.NAME3)>0) );
