...
/**
 * Person Identification/Name current identification model.
 *
 * NOTE: This domain is used to maintain the current SPRIDEN record
 * where the change indicator is null. It does not maintain alternate
 * SPRIDEN records.
 */
@Entity
...
class PersonIdentificationNameCurrent implements Serializable {
    ...
    public String toString() {
        """PersonIdentificationNameCurrent[
					id=$id,
					pidm=$pidm,
					bannerId=$bannerId,
					lastName=$lastName,
    ...
    boolean equals(o) {
        ...
        PersonIdentificationNameCurrent that = (PersonIdentificationNameCurrent) o;
...
//  The Banner ID and PIDM are nullable: true because the API generates these
    static constraints = {
        ...
        changeIndicator(nullable: true,
                validator: { field ->
                    if (field) {
                        return "changeIndicatorMustBeNull"
                    }
                }
        )
    ...
    def private static finderByAll = {
        def query = """FROM  PersonIdentificationNameCurrent a WHERE a.pidm = :pidm"""
